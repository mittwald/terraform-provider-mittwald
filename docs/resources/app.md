...
- `created_at` (String) The time at which the app installation was created
...
- `phase` (String) The current phase of the app installation (e.g. `pending`, `installing`, `ready`, `upgrading`)
